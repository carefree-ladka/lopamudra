    ...
    <div className="absolute inset-0 flex items-center justify-center z-30 pointer-events-none bg-gradient-to-br from-pink-900/90 via-purple-900/90 to-rose-900/90 backdrop-blur-sm">
      ...
      <div className="max-w-6xl mx-4 w-full relative">
        ...
        <div className="text-center mb-6">
          ...
          <p
            className="text-xl md:text-2xl text-yellow-200 mb-3"
            style={{
              fontFamily: "Georgia, serif",
        ...
        <div
          ...
          className="relative bg-gradient-to-br from-white/95 via-pink-50/95 to-rose-100/95 backdrop-blur-md rounded-3xl p-6 md:p-10 shadow-2xl border-4 border-yellow-300/60 text-center transform transition-all duration-700 animate-slide-in-right pointer-events-auto cursor-pointer"
          style={{
            boxShadow:
        ...
        >
          ...
          <div className="absolute top-4 right-4 text-3xl text-yellow-500">
            ✨
          </div>
          <div className="absolute bottom-4 left-4 text-3xl text-yellow-500">
            ✨
          </div>
          <div className="absolute bottom-4 right-4 text-3xl text-yellow-500">
            ✨
          </div>

          <div className="mb-4">
            <span className="inline-block px-4 py-2 bg-gradient-to-r from-yellow-400 to-pink-400 rounded-full text-white text-base font-bold shadow-lg">
          ...
          <p
            className="text-base md:text-xl leading-relaxed max-w-3xl mx-auto text-gray-800"
            style={{
              fontFamily: "Georgia, serif",
        ...
        <div className="mt-6 text-center">
          ...
          <div className="w-full bg-gradient-to-r from-pink-200/30 via-purple-200/30 to-rose-200/30 rounded-full h-2 max-w-md mx-auto border border-pink-300/30">
            <div
              className="bg-gradient-to-r from-yellow-400 via-pink-400 to-rose-400 h-2 rounded-full transition-all duration-700 shadow-lg"
              style={{
          ...
          <p
            className="text-yellow-200 mt-3 text-base"
